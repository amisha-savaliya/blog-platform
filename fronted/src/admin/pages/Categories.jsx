...
export default function Categories() {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-6 py-10 mt-2 ">
      {/* Header */}
      <div className="p-4 shadow-sm rounded mb-4 d-flex justify-content-between align-items-center flex-wrap">
        <h2 className="heading text-primary-emphasis fw-bold">
      ...
      <div className=" rounded-xl shadow-md overflow-hidden border bg-white ">
        <table className="table hover shadow-sm rounded  w-full border">
      ...
      {showEdit && (
        <div className="modal d-block py-5 align-content-center" style={{ background: "rgba(0,0,0,.6)" }}>
