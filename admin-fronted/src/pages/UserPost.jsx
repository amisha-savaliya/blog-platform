...
import { deletePost, fetchPosts, likePost, setPage } from "../Redux/features/posts/postsSlice";
          ...
          {posts.map((post) => (
            <div className="col-md-4" key={post.id}>
              ...
              >
                ...
                <h4 className="fw-semibold text-black mt-2">{post.title}</h4>
                ...
                <div className="card-footer d-flex gap-3 align-items-center mt-3 mb-0">
                  <button
                    className={
